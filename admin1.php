...
<div class="topnav"> 
    ...
    <div>
        <a href="update_profile1.php"><button>Update Profile</button></a>
        <a href="manage_authors.php"><button>Manage Authors</button></a>
        <a href="view_articles1.php"><button>View Articles</button></a>
